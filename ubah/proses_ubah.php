<?php
    ...
    $query = "UPDATE tbl_remaja SET nama_remaja = '$nama_remaja', tanggal_lahir_remaja = '$tanggal_lahir_remaja', notelp_remaja = '$notelp_remaja', email_remaja = '$email_remaja', kelompok_remaja = '$kelompok_remaja', kategori_remaja = '$kategori_remaja'
    WHERE id_remaja = '$id_remaja'";
