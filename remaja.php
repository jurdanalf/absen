...
<head>
    ...
    <link rel="stylesheet" href="css/remaja.css">
</head>
<body>
    ...
    <main>
        ...
        <div class="fitur">
            <div class="search">
                <input type="text" id="liveSearch" placeholder="Search...." autocomplete="off" size="40">
            </div>
            <div class="tambah">
                <a href="tambah/tambah_remaja.php">Tambah Remaja</a>
